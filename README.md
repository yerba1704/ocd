...
To install __ora* CODEDOC__ execute the script `admin_install.sql`. This will create a new user `OCD`, grant all required privileges to that user and grant the `API` package to public. You should change the pre-defined environment variables _ocd_\__password_ and _ocd_\__tabespace_ according to your environment.
